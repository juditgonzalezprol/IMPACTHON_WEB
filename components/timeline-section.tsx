...
const timelineEvents = [
  {
    ...
    title: "Open Doors",
    time: "Viernes 17:00",
    description: "Recepcion y acreditacion de participantes",
    day: "DIA 1",
  },
  {
    icon: PartyPopper,
    title: "Apertura + Retos",
    time: "Viernes 18:00",
    description: "Ceremonia de apertura y presentacion de los retos",
    day: "DIA 1",
  },
  {
    icon: Code2,
    ...
    description: "Horas de desarrollo intensivo, comidas incluidas",
    day: "DIA 1-3",
    featured: true,
  },
  {
  ...
  {
    icon: Gamepad2,
    title: "Minijuegos Sorpresa",
    time: "Sabado madrugada y tarde",
    description: "Actividades sorpresa para desconectar",
    day: "DIA 2",
  },
  {
    icon: Presentation,
    title: "Pitches",
    time: "Domingo 10:00",
    description: "Presentacion de proyectos ante los tribunales",
    day: "DIA 3",
  },
  {
    icon: Award,
    title: "Premios y Clausura",
    time: "Domingo 13:00",
    description: "Pitches finalistas y entrega de premios",
    day: "DIA 3",
    featured: true,
  },
]
